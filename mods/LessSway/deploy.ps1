...
" " | & "C:\dev\stalker2\unrealpak-main\UnrealPak-With-Compression.bat" "C:\dev\stalker2\mods\mods\LessSway\LessSway_P"

# Define source and destination
$SourceFile = "C:\dev\stalker2\mods\mods\LessSway\LessSway_P.pak"
...
Write-Host "Successfully deployed LessSway_P.pak to $DestDir" -ForegroundColor Green
