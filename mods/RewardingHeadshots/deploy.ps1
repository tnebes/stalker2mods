...
" " | & "C:\dev\stalker2\unrealpak-main\UnrealPak-With-Compression.bat" "C:\dev\stalker2\mods\mods\RewardingHeadshots\RewardingHeadshots_P"

# Define source and destination
$SourceFile = "C:\dev\stalker2\mods\mods\RewardingHeadshots\RewardingHeadshots_P.pak"
...
Write-Host "Successfully deployed RewardingHeadshots_P.pak to $DestDir" -ForegroundColor Green
