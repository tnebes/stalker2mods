...
" " | & "C:\dev\stalker2\unrealpak-main\UnrealPak-With-Compression.bat" "C:\dev\stalker2\mods\mods\SkifsHolyPistol\SkifsHolyPistol_P"

# Define source and destination
$SourceFile = "C:\dev\stalker2\mods\mods\SkifsHolyPistol\SkifsHolyPistol_P.pak"
...
Write-Host "Successfully deployed SkifsHolyPistol_P.pak to $DestDir" -ForegroundColor Green
