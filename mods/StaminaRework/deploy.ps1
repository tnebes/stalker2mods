...
" " | & "C:\dev\stalker2\unrealpak-main\UnrealPak-With-Compression.bat" "C:\dev\stalker2\mods\mods\StaminaRework\StaminaRework_P"

# Define source and destination
$SourceFile = "C:\dev\stalker2\mods\mods\StaminaRework\StaminaRework_P.pak"
...
Write-Host "Successfully deployed StaminaRework_P.pak to $DestDir" -ForegroundColor Green
