...
def get_rank_configs():
    ...
    rank_map = {"Newbie": 0.5, "Experienced": 2, "Veteran": 3, "Master": 4, "Zombie": 1}

    # Distance penalties
    dist_penalty = {"Short": 0.0, "Medium": 1.0, "Long": 2.2}

    # Range multipliers
    range_mults = {"Newbie": 0.8, "Experienced": 1.5, "Veteran": 1.5, "Master": 1.5, "Zombie": 1.0}

    # Hardcoded floors
    floors_min = {"Newbie": {"Short": 0, "Medium": 0, "Long": 0}, "Experienced": {"Short": 1, "Medium": 0, "Long": 0},
        "Veteran": {"Short": 1, "Medium": 0, "Long": 0}, "Master": {"Short": 1, "Medium": 1, "Long": 0},
        "Zombie": {"Short": 0, "Medium": 0, "Long": 0}}
    floors_max = {"Newbie": {"Short": 1, "Medium": 1, "Long": 0}, "Experienced": {"Short": 1, "Medium": 1, "Long": 0},
        "Veteran": {"Short": 1, "Medium": 1, "Long": 1}, "Master": {"Short": 1, "Medium": 1, "Long": 1},
        "Zombie": {"Short": 1, "Medium": 0, "Long": 0}}

    # Burst size and Guaranteed hit parameters
    burst_logic = {
        "Newbie": {"burst_mult": 1.25, "min_long_burst_mult": 1.5, "long_burst_mult": 1.5, "min_add": 0, "max_add": 0,
            "guaranteed_add_long": 0, "guaranteed_add_medium": 0, "guaranteed_add_short": 0},
        "Experienced": {"burst_mult": 1.0, "long_burst_mult": 1.15, "min_add": 0, "max_add": 0,
            "guaranteed_add_long": 0, "guaranteed_add_medium": 0, "guaranteed_add_short": 0,
            "ignore_disp_max_inc_if_small": 1},
        "Veteran": {"burst_mult": 1.0, "long_burst_mult": 0.75, "medium_burst_mult": 0.85, "short_burst_mult": 1.1,
            "min_add": 0, "max_add": 1},
        "Master": {"burst_mult": 1.0, "long_burst_mult": 0.4, "medium_burst_mult": 0.75, "short_burst_mult": 1.25,
            "min_add": 0, "max_add": 0, "guaranteed_add_long_min": 0, "guaranteed_add_long_max": -1,
            "guaranteed_add_medium_min": 0, "guaranteed_add_medium_max": 1, "guaranteed_add_short_mag_pct": 0.04},
        "Zombie": {"burst_mult": 1.5, "min_add": 0, "max_add": 0}}
    ...
    for r_name in ranks:
        ...
        results[r_name] = {"range_mult": range_mults[r_name], "ignore_disp_min": floors_min[r_name],
            "ignore_disp_max": floors_max[r_name], "ignore_disp_chance_min": chance_min,
            "ignore_disp_chance_max": chance_max, "burst_logic": burst_logic.get(r_name, {})}
    return results


def print_burst_projections(output_to_file=False):
    data = get_rank_configs()
    burst_scenarios = [(3, 6), (4, 14), (8, 16)]
    brackets = ["Short", "Medium", "Long"]
    output = []
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--inspect", action="store_true",
                        help="Print burst projections to curves.md for inspection.")
